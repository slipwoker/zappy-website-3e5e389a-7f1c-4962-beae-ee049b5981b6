    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "קואלה צלמים משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '3e5e389a-7f1c-4962-beae-ee049b5981b6',
                    name: data.name || '',
                    email: data.email || '',
